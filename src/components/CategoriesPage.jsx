...
const SinglePage=()=>{
 ...
 return(
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center min-h-[30vh] w-full">
          ...
          <div className="text-center md:text-left">
            <h1 className="text-[#333533] font-bold text-[6vw] md:text-[3vw] font-sans leading-tight">
              Create Timeless Memories with Personalized Photo Gifts
            </h1>
            <p className="text-[#7f8c8d] font-medium text-[3vw] md:text-[1.2vw] mt-4 leading-relaxed">
              Capture and cherish precious moments with personalized photo gifts. Thoughtful and unique, these are perfect for expressing love and creating lasting memories.
            </p>
            <div className="font-semibold text-slate-700 opacity-75 text-[4vw] md:text-[1.5vw] mt-6">
              Starting at <span className="">129</span>
            </div>
          </div>
    ...
    <div id="section2">const [items, setItems] = useState([]);
