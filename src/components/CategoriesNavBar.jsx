      ...
      <div>
        <div className="bg-gradient-to-r from-[#e7d8c9] to-[#eae0d5]">
          <div className="pt-4 pb-4 px-6 md:px-16">
            ...
            <motion.div
              className="grid grid-cols-1 md:grid-cols-3 gap-2 items-center min-h-[28vh] sm:h-[300px]  w-full"
            >

              {/* Left Section */}
              <div className="text-center col-span-1 md:text-left">
              ...
              <div className="relative  col-span-2 ">
                <div className="lg:w-full w-full">
                  <motion.div className="relative h-[380px] sm:h-[250px]  rounded-xl overflow-hidden">
              ...
              {content.subCategory.map((item) => (
                ...
                >
                  ...
                  <div className="p-4 h-[10%] w-full flex justify-center items-center">
                    <h2 className="text-md font-semibold text-nowrap ">{item.subTitle.length > 20 ? `${item.subTitle.slice(0, 10)}...` : item.subTitle}</h2>
                  </div>
                </Link>
              ))}
            </div>
