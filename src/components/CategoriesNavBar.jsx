...
const CategoriesNavBar = () => {
  ...
  const datafile = {
    ...
    itinerary: {
      ...
      Description1: "Create detailed travel itineraries for your trips. ghthrjhytjreyse4",
      Details1:
  ...
  const categories = {
    "print invitations": {
      ...
      Description1: "Create beautiful wedding, party, pooja and other events invitations with unique shapes and artistic designs. Each piece is tailored to add elegance and charm to your celebrations. Celebrate your moments with creative and unforgettable invites.",
    ...
    "e-invitations": {
      title: "E Invitations",
      url: "/e-invitations",
      Description1: "We make digital invitations for weddings, parties, poojas, and all celebrations with creative and elegant designs. Each invitation is thoughtfully crafted to reflect the spirit of your event. Celebrate your special moments with personalized, memorable digital invites.",
      slang: 'Where Creativity Meets Celebration  " A Digital Journey for Every Event"',
      Description:
        "Transform your wedding announcements with our innovative digital invitation platform that combines contemporary design with cutting-edge technology. Our e-invitations offer unlimited creative possibilities while providing convenient tracking and management features for a seamless guest experience.",
      subCategory: [
        {
