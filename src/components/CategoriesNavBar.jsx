        ...
        <div className="px-[6%] pt-[1%] py-6  text-gray-800">
          <section className="mb-6">
            ...
            <p className="text-lg leading-relaxed">
              Why print just one when you can print 24! Yes, all our Card Stock
              Prints come in a set of 24 prints with an option to add colourful
              and patterned borders to each of them. Make photo printing a habit
              and bring photos off your device with our premium quality prints.
              From Square Photo Prints to Polaroids, these are the most
              cost-effective way to personalize any gift hamper!
            </p>
          </section>
          ...
          <section className="mb-6">
            ...
            <p className="text-lg leading-relaxed">
              Simply upload your photos with multiple source options like your
              computer or Google Photos. Edit your images in the next screen,
              crop or adjust your images and give them a final review. Hit print
          ...
          <section className="mb-6">
            ...
            <ul className="list-disc list-inside text-lg leading-relaxed">
              <li>
                Pick from different print sizes and formats – Mini Prints,
                Square prints, 4x6, 5x7, and Retro prints.
              </li>
              <li>
                Add different colourful and patterned borders to each print.
              </li>
              <li>
                Pick from a variety of themed stickers to add to your pictures.
              </li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-lg leading-relaxed">
              <li>
                The best about these personalized photobooks is that they are
                fully customizable, of excellent quality, and thus make for the
                best photo gifts and keepsakes!
              </li>
              <li>
                Create simple photo displays on your walls. Stick them using
                wall-safe washi tape or clips and thread.
              </li>
            </ul>
          </section>
        </div>
