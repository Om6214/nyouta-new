...
const HeroBanner = () => {
    ...
    return (
        <motion.div style={{ scale, opacity }} className="flex min-h-screen items-center bg-priBg border rounded-3xl mx-8 ">
                ...
                <div className="flex gap-8 flex-col-reverse lg:flex-row   lg:gap-16">
                    ...
                    >
                        <h1 className="text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl md:text-8xl">
                            <span className="mt-2 mb-8 block font-heroFont"><span className="text-amber-700">न्यौता
