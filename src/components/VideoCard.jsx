    ...
    <div>
        <div className='lg:px-16 px-4 py-8 lg:py-16 flex flex-col lg:flex-row gap-8 justify-around bg-gradient-to-br from-amber-50 to-amber-70'>
            ...
            <div className='flex flex-col lg:gap-12 px-10 gap-6 items-start justify-center'>
                <h1 className='lg:text-6xl text-4xl font-primaryFont'>Print, Preserve & Cherish</h1>
                ...
                <button className='flex items-center gap-2 bg-gradient-to-r from-[#563B0E] to-amber-800 rounded-lg text-white hover:bg-gradient-to-r hover:from-amber-900 hover:to-amber-700 px-8 py-2 lg:text-xl' onClick={() => navigate('/products')}>Shop Now <span><SquareArrowOutUpRight /></span></button>
            </div>
        </div>
    </div>
  )
