    ...
    <div>
        <div className='lg:px-16 px-4 py-8 lg:py-16 flex flex-col lg:flex-row gap-8 justify-around bg-gradient-to-br from-amber-50 to-amber-70'>
            ...
            <div className='flex flex-col lg:gap-12 px-10 gap-6 items-start justify-center'>
                <h1 className='lg:text-6xl text-4xl font-primaryFont font-bold'>Print, Preserve & Cherish</h1>
                ...
                <button className='flex items-center gap-2 bg-gradient-to-br from-amber-700 via-amber-600 to-amber-900 rounded-lg text-white hover:bg-gradient-to-r hover:from-amber-900 hover:to-amber-700 px-8 py-2 shadow-xl lg:text-xl transition duration-300 ease-in' onClick={() => navigate('/products')}>Shop Now <span><SquareArrowOutUpRight /></span></button>
            </div>
        </div>
    </div>
  )
